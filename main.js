...
function MarkQuiz() {
  // What if this is the second time clicking the button?  What needs to be reset here?
  result = 0;
  ...
  if (Q3R == "kang" || Q3R == "kang the conqueror") {
  ...
  if (Q7R == "nova") {
    ...
    Img7.style.border = "3px solid green";
    Img7.src = "img/nova.jpg";
    Q7Response.style.border = "3px solid green";
  ...
  //OUTCOME THE SCORE MARK
  let outputScore = document.getElementById("Outcome");

  outputScore.innerHTML = (result * 100) / 7;
  document.getElementById(
    "Outcome"
  ).innerHTML = `YOUR COURSE MARK AVERAGE IS: ${outputScore.innerHTML}%`;
